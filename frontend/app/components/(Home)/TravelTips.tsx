...
const tips = [
    {
        ...
        content:
            "Learn how to pack efficiently and never forget important items.",
    ...
    },
    {
        ...
        content:
            "Discover authentic local food experiences wherever you travel.",
    ...
    },
    {
        ...
        content:
            "Travel more while spending less with these proven strategies.",
        category: "Budget",
    },
];
const TravelTips = () => {
