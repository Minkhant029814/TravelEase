...
export function FormattedDate(data: string) {
    ...
    return formattedDate; // Displays: June 22, 2025
}
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-gray-500">
                                    Member since{" "}
                                    {FormattedDate(users.created_at)}
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="p-6">
                        ...
                        {activeTab === "reservations" && (
                            <div>
                                ...
                                <p className="text-gray-500 mb-6">
                                    View and manage all your upcoming and past
                                    trips.
                                </p>
                                <div className="bg-white shadow overflow-hidden sm:rounded-md">
                        ...
                        {activeTab === "support" && (
                            <div>
                                ...
                                <p className="text-gray-500 mb-6">
                                    Need help with your booking? Our support
